[![Build status](https://ci.appveyor.com/api/projects/status/iqqqlthlnpwa4cg6?svg=true)](https://ci.appveyor.com/project/ZlayaZayaZ/dz8-setcontainer)

# Домашнее задание к лекции «Контейнеры»
[Исходник домашнего задания](https://github.com/netology-code/ajs-homeworks/blob/master/containers/README.md)
